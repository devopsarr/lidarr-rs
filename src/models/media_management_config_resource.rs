...
pub struct MediaManagementConfigResource {
    ...
    pub id: Option<i32>,
    #[serde(rename = "autoUnmonitorPreviouslyDownloadedTracks", skip_serializing_if = "Option::is_none")]
    pub auto_unmonitor_previously_downloaded_tracks: Option<bool>,
    ...
    #[serde(rename = "createEmptyArtistFolders", skip_serializing_if = "Option::is_none")]
    pub create_empty_artist_folders: Option<bool>,
...
impl MediaManagementConfigResource {
    pub fn new() -> MediaManagementConfigResource {
        MediaManagementConfigResource {
            id: None,
            auto_unmonitor_previously_downloaded_tracks: None,
            recycle_bin: None,
            recycle_bin_cleanup_days: None,
            download_propers_and_repacks: None,
            create_empty_artist_folders: None,
