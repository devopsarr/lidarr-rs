...
pub struct AlbumResourcePagingResource {
    ...
    pub records: Option<Option<Vec<models::AlbumResource>>>,
}

impl AlbumResourcePagingResource {
    pub fn new() -> AlbumResourcePagingResource {
